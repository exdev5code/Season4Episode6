...
//	GS-N	1.00.77 JPN	- Completed (no changes)
//////////////////////////////////////////////////////////////////////
...
//004A2100   /> \55                            PUSH EBP
void CQuestUtil::Quest3rdRequestInfo(LPOBJ lpObj) //identical gs-cs 56
{
	PMSG_004A2100 pMsg;
...
//004A2190   /> \55                            PUSH EBP
void CQuestUtil::Quest3rdLoadInfo(LPBYTE aRecv) //identical gs-cs 56
{
...
//004A23A0   /> \55                            PUSH EBP
void CQuestUtil::Quest3rdSaveInfo(LPOBJ lpObj) //identical gs-cs 56
{
