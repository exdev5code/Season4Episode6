	...
	while ( true )
	{
		...
		if ( Token == 1 )
		{
			...
			while ( true )
			{
				...
				this->m_Mp[this->m_Count].m_Type = (WORD)TokenNumber;
				Token = GetToken();	this->m_Mp[this->m_Count].m_MapNumber = (BYTE)TokenNumber;
				Token = GetToken();	this->m_Mp[this->m_Count].m_Dis = (BYTE)TokenNumber;
				Token = GetToken();	this->m_Mp[this->m_Count].m_X = (BYTE)TokenNumber;
				Token = GetToken();	this->m_Mp[this->m_Count].m_Y = (BYTE)TokenNumber;
				this->m_Mp[this->m_Count].m_ArrangeType = Type;

				if ( Type == 1 || Type == 3 )
				{
					Token = GetToken();	this->m_Mp[this->m_Count].m_W = (BYTE)TokenNumber;
					Token = GetToken();	this->m_Mp[this->m_Count].m_H = (BYTE)TokenNumber;
				}
				else if ( Type == 2 )
				{
				...
				Token = GetToken();	this->m_Mp[this->m_Count].m_Dir = (BYTE)TokenNumber;
