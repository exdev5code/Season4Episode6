	...
	while ( true )
	{
		...
		while ( true )
		{
			if ( type == 0 )
			{
				...
				EIIL.m_btSection = (BYTE)TokenNumber;

				Token = GetToken();
				EIIL.m_btType = (BYTE)TokenNumber;

				Token = GetToken();
				EIIL.m_btIndex = (BYTE)TokenNumber;

				Token = GetToken();
				EIIL.m_btLevel = (BYTE)TokenNumber;

				Token = GetToken();
				EIIL.m_btDur = (BYTE)TokenNumber;
