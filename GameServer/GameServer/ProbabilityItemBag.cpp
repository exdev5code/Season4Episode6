			...
			else if ( st == 2 )
			{
				...
				while ( true )
				{
					...
					while ( true )
					{
						...
						this->BagObject[this->m_iBagObjectCount].m_type = (BYTE)TokenNumber;

						Token = GetToken();
						this->BagObject[this->m_iBagObjectCount].m_index = (BYTE)TokenNumber;

						Token = GetToken();
						this->BagObject[this->m_iBagObjectCount].m_minLevel = (BYTE)TokenNumber;

						Token = GetToken();
						this->BagObject[this->m_iBagObjectCount].m_maxLevel = (BYTE)TokenNumber;

						Token = GetToken();
						this->BagObject[this->m_iBagObjectCount].m_isskill = (BYTE)TokenNumber;

						Token = GetToken();
						this->BagObject[this->m_iBagObjectCount].m_isluck = (BYTE)TokenNumber;

						Token = GetToken();
						this->BagObject[this->m_iBagObjectCount].m_isoption = (BYTE)TokenNumber;

						Token = GetToken();
						this->BagObject[this->m_iBagObjectCount].m_isexitem = (BYTE)TokenNumber;
...
BOOL CProbabilityItemBag::DropNewYearLuckMonsterReward(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	...
	if ( this->GetBagCount() > 0 )
	{
		...
		ItemSerialCreateSend(lpObj->m_Index, (BYTE)btMapNumber, (BYTE)x, (BYTE)y, type, (BYTE)level, (BYTE)dur, (BYTE)Option1, (BYTE)Option2, (BYTE)Option3, lpObj->m_Index, (BYTE)loc12, 0);
...
void CProbabilityItemBag::DropSetItem(int aIndex, int itemnum, BYTE btMapNumber, int cX, int cY)
{
	...
	ItemSerialCreateSend(aIndex,btMapNumber,(BYTE)cX,(BYTE)cY,itemnum,0,0,(BYTE)Option1,(BYTE)Option2,(BYTE)Option3,aIndex,0,(BYTE)SetOption);
...
{	
	...
	if ( this->GetBagCount() > 0 )
	{
		...
		ItemSerialCreateSend(lpObj->m_Index, btMapNumber, (BYTE)x, (BYTE)y, type, (BYTE)level, (BYTE)dur, (BYTE)Option1, (BYTE)Option2, (BYTE)Option3, lpObj->m_Index, (BYTE)loc12, 0);
