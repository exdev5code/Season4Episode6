		...
		while ( true )
		{
			...
			while ( true )
			{
				if ( iType == 0 )
				{
					...
					iAppearanceDelay = (int)TokenNumber;

					Token = GetToken();
					iZoneCloseDelay = (int)TokenNumber;

					Token = GetToken();
					iZoneOpenDelay = (int)TokenNumber;
				...
				else if ( iType == 3 )
				{
					...
					iPattern[0] = (int)TokenNumber;

					Token = GetToken();
					iPattern[1] = (int)TokenNumber;

					Token = GetToken();
					iPattern[2] = (int)TokenNumber;

					Token = GetToken();
					iPattern[3] = (int)TokenNumber;

					Token = GetToken();
					iPattern[4] = (int)TokenNumber;

					Token = GetToken();
					iPattern[5] = (int)TokenNumber;
