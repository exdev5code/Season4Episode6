		...
		if ( Token == 1 )
		{
			...
			if (Type == 0)
			{
				...
				while(true)
				{
					...
					m_GamblingInfo[Count].m_iSkillRate = (int)TokenNumber;

					Token = GetToken();
					m_GamblingInfo[Count].m_iLuckRate = (int)TokenNumber;

					Token = GetToken();
					m_GamblingInfo[Count].m_iOptionRate = (int)TokenNumber;

					Token = GetToken();
					m_GamblingInfo[Count].m_iExcRate = (int)TokenNumber;

					Token = GetToken();
					m_GamblingInfo[Count].m_iSortItemRate = (int)TokenNumber;
			...
			else if (Type == 1)
			{
				...
				while(true)
				{
					...
					this->m_iBagItemOptionRate[Count] = (int)TokenNumber;
			...
			else if (Type == 2)
			{
				...
				while(true)
				{
					...
					this->m_dwSpecialItemRate[Count] = (DWORD)TokenNumber;
			...
			else if (Type == 3)
			{
				...
				while(true)
				{
					...
					this->m_iBagItemExcRate[Count] = (int)TokenNumber;
			...
			else if (Type == 4)
			{
				...
				while(true)
				{
					...
					this->m_iExcRatePerItemKind[Count] = (int)TokenNumber;

					Token = GetToken();
					this->m_iGeneralExcRate[Count] = (int)TokenNumber;
			...
			else if (Type >= 5)
			{
				...
				while(true)
				{
					...
					this->BagObject[m_iGambleBagCount].m_type = (BYTE)TokenNumber;
						
					Token = GetToken();
					this->BagObject[m_iGambleBagCount].m_index = (BYTE)TokenNumber;

					Token = GetToken();
					this->BagObject[m_iGambleBagCount].m_minLevel = (BYTE)TokenNumber;

					Token = GetToken();
					this->BagObject[m_iGambleBagCount].m_maxLevel = (BYTE)TokenNumber;

					Token = GetToken();
					this->BagObject[m_iGambleBagCount].m_isskill = (BYTE)TokenNumber;

					Token = GetToken();
					this->BagObject[m_iGambleBagCount].m_isluck = (BYTE)TokenNumber;

					Token = GetToken();
					this->BagObject[m_iGambleBagCount].m_isoption = (BYTE)TokenNumber;

					Token = GetToken();
					this->BagObject[m_iGambleBagCount].m_isexitem = (BYTE)TokenNumber;
...
BYTE CGambleSystem::TryGamble(int aIndex, BYTE MapNumber, int cX, int cY, BYTE btRareItemNum) //0049C6D0 (Identical)
{
	...
	if(this->GetBagItemCount() > 0)
	{
		...
		ItemSerialCreateSend(lpObj->m_Index,(BYTE)MapNumber,(BYTE)MapPosX,(BYTE)MapPosY,ItemType,(BYTE)Level,(BYTE)Dur,(BYTE)Op1,(BYTE)Op2,(BYTE)Op3,lpObj->m_Index,(BYTE)NewOp,0);
