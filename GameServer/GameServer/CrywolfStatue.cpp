...
void CCrywolfStatue::SetStatueViewState(LPOBJ lpObj, int iAltarNumber)
{
	...
	{
		case 1:
			gObjApplyBuffEffectDuration(lpObj, AT_CRYWOLF_PROTECTION1, 0, 0, 0, 0, -10);
			break;
		case 2:
			gObjApplyBuffEffectDuration(lpObj, AT_CRYWOLF_PROTECTION2, 0, 0, 0, 0, -10);
			break;
		case 3:
			gObjApplyBuffEffectDuration(lpObj, AT_CRYWOLF_PROTECTION3, 0, 0, 0, 0, -10);
			break;
		case 4:
			gObjApplyBuffEffectDuration(lpObj, AT_CRYWOLF_PROTECTION4, 0, 0, 0, 0, -10);
			break;
		case 5:
			gObjApplyBuffEffectDuration(lpObj, AT_CRYWOLF_PROTECTION5, 0, 0, 0, 0, -10);
			break;
	}
}
