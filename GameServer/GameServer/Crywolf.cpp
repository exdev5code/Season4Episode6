...
void CCrywolf::MakeRewardForAltarElf(int iAltarUserIndex)
{
	...
	ItemSerialCreateSend(gObj[iAltarUserIndex].m_Index, (BYTE)gObj[iAltarUserIndex].MapNumber, (BYTE)gObj[iAltarUserIndex].X, (BYTE)gObj[iAltarUserIndex].Y, iItemNumber, 0, 0, 0, 0, 0, iAltarUserIndex, 0, 0);
...
{
	int iItemNumber = ITEMGET(14,13);
	ItemSerialCreateSend(gObj[iUserIndex].m_Index, (BYTE)gObj[iUserIndex].MapNumber, (BYTE)gObj[iUserIndex].X, (BYTE)gObj[iUserIndex].Y, iItemNumber, 0, 0, 0, 0, 0, iUserIndex, 0, 0);
...
int CCrywolf::CalcGettingRewardExp(int iUserIndex, int iMVPRank)
{
	...
	gObjPandaUserSetExp(&gObj[iUserIndex],iRewardExp);	//Panda Use
	gObjUserExperienceMain(&gObj[iUserIndex],iRewardExp);
