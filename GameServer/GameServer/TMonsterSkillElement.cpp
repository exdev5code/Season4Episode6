...
BOOL TMonsterSkillElement::ApplyElementHP(int iIndex, int iTargetIndex)
{
	...
	if ( this->m_iIncAndDecType != MSE_INCDEC_TYPE_NONE )
	{
		...
		{
			iIncDecValue = (int)((((float)(lpTargetObj->Life) * (float)(this->m_iIncAndDecValue)))/100.0f);
...
BOOL TMonsterSkillElement::ApplyElementMP(int iIndex, int iTargetIndex)
{
	...
	if ( this->m_iIncAndDecType != MSE_INCDEC_TYPE_NONE )
	{
		if ( this->m_iIncAndDecType < MSE_INCDEC_TYPE_CONSTANTINC )
		{
			iIncDecValue = (int)((((float)(lpTargetObj->Mana) * (float)(this->m_iIncAndDecValue)))/100.0f);
	...
	{
		lpTargetObj->Mana = 0;
		GCManaSend(lpTargetObj->m_Index, (int)lpTargetObj->Mana, 0xFF, 0, (int)lpObj->BP);
		return TRUE;
	}
...
BOOL TMonsterSkillElement::ApplyElementAG(int iIndex, int iTargetIndex)
{
	...
	{
		lpTargetObj->Mana = (float)(lpTargetObj->MaxBP + lpTargetObj->AddBP);
		GCManaSend(lpTargetObj->m_Index, (int)lpTargetObj->Mana, 0xFF, 0, (int)lpTargetObj->BP);
