...
BOOL CKanturu::LoadData(LPSTR lpszFileName)
{
	...
	try
	{
		...
		this->m_BattleStanby.LoadData(gDirPath.GetNewPath(".\\Events\\Kanturu.dat"));
		this->m_BattleOfMaya.LoadData(gDirPath.GetNewPath(".\\Events\\Kanturu.dat"));
		this->m_BattleOfNightmare.LoadData(gDirPath.GetNewPath(".\\Events\\Kanturu.dat"));
		this->m_TowerOfRefinement.LoadData(gDirPath.GetNewPath(".\\Events\\Kanturu.dat"));
	}
	catch (...)
	{
...
int CKanturu::CheckEnterKanturu(int iUserIndex)
{
		 ...
		 this->m_BattleOfMaya.GetEntrancePermit() == TRUE)
	{
		...
		if ( (gObj[iUserIndex].pInventory[7].m_Type < ITEMGET(12,0) || gObj[iUserIndex].pInventory[7].m_Type > ITEMGET(12,6) ) &&
			 ...
			 //Custom Wings4
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,180) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,181) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,182) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,183) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,184) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,185) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,186) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,187) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,188) &&
#ifdef _WINGS_5LVL_
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,189) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,190) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,191) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,192) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,193) &&
			 gObj[iUserIndex].pInventory[7].m_Type != ITEMGET(12,194) &&
#endif
			 //
