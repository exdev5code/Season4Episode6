		...
		while( true )
		{
			...
			while( true )
			{
				if( iType == 0 )
				{
					...
					iItemType = (WORD)TokenNumber;
					Token = GetToken();

					iItemIndex = (WORD)TokenNumber;
					Token = GetToken();

					iBuyPoint = (WORD)TokenNumber;
					Token = GetToken();

					iCondition = (WORD)TokenNumber;
					Token = GetToken();

					iAbility = (BYTE)TokenNumber;
					Token = GetToken();

					iKeepTime = (int)TokenNumber;
					Token = GetToken();

					iAddExpPercent = (WORD)TokenNumber;
					Token = GetToken();

					iGetItemPercent = (WORD)TokenNumber;
					Token = GetToken();

					iStopExp = (BYTE)TokenNumber;
