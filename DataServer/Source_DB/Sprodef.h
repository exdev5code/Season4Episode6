...
typedef struct
{
	...
	WORD ChatLitmitTime;
	int iFruitPoint;
	int PCPoint;	//ExADD PCPoint;
	int Reset;		//ExADD Reset
	int GReset;		//ExADD GReset
	int ExFreePoints;	//ExADD	ExFreePoints
	int ExQuestNum;	//ExADD ExQuestNum
	int ExQuestKill;	//ExADD ExQuestKill
	int ExCred;
